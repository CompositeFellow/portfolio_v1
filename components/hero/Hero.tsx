...
const skillsList = skillsArray.map((skill) => {
	return (
		<div
			key={skill.skill}
			className='flex flex-row w-[4rem] h-[1rem] my-[.5rem] mx-[.5rem] lg:mx-[.5rem] 2xl:mx-[1rem] text-[0.5rem] text-[#FFFFFF]'
		>
	...
	return (
		<SectionMainColumn id={"hero"} classname='flex flex-row flex-wrap mt-[1rem] xl:mt-[2rem]  justify-center'>
			<div className='w-full h-fit flex flex-col items-center text-center'>
				<h1 className='text-white text-[1.5rem]  md:text-[1.25rem] lg:text-[2rem] 2xl:text-[2.5rem] mb-[.5rem] font-zenDots'>
					Hello I&apos;m Trevor Danahy
				</h1>
				<h2 className='text-orangeDark italic text-[.75rem] lg:text-[1.25rem] 2xl:text-[1.75rem] font-zenDots mb-[.5rem]'>
					Fullstack Developer
				</h2>
